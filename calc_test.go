...
func TestCalcCellValue(t *testing.T) {
	...
	mathCalc := map[string]string{
		...
		// HYPERLINK
		"=HYPERLINK(\"https://github.com/Aymeric-Henry/excelize\")":              "https://github.com/Aymeric-Henry/excelize",
		"=HYPERLINK(\"https://github.com/Aymeric-Henry/excelize\",\"Excelize\")": "Excelize",
		// VLOOKUP
	...
	mathCalcError := map[string][]string{
		...
		"=HYPERLINK(\"https://github.com/Aymeric-Henry/excelize\",\"Excelize\",\"\")": {"#VALUE!", "HYPERLINK allows at most 2 arguments"},
		// VLOOKUP
